        ...
        <div className="items-center gap-16 lg:grid lg:grid-cols-2">
          ...
          <div className="text-gray-600 dark:text-gray-400">
            ...
            <p className="mb-4">
              ...
              resources. So we built a community-powered platform where students
              can upload, explore, and download documents freely while earning
              credit and climbing the leaderboard.
            </p>
            <p className="mb-4">
  ...
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
    <div className="flex flex-col items-center text-center">
      <img
        ...
        alt="Irfan"
      />
      <p className="font-medium text-gray-900 dark:text-white">Irfan Saeed</p>
    ...
    <div className="flex flex-col items-center text-center">
      <img
        ...
        alt="Aamir"
      />
      <p className="font-medium text-gray-900 dark:text-white">Aamir Hussain</p>
      <p className="text-sm text-gray-500 dark:text-gray-400">
        UI/UX Designer 🎨
      </p>
    </div>
    <div className="flex flex-col items-center text-center">
      <img
        ...
        alt="Abou Bakar"
      />
      <p className="font-medium text-gray-900 dark:text-white">Abou Bakar Arisar</p>
      <p className="text-sm text-gray-500 dark:text-gray-400">
        Backend & Auth 🔐
      </p>
    </div>
